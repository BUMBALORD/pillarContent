...
function App() {
  ...
  return (
    ...
    <Typography variant="h2" align="center" className={classes.section}>
      ...
      <Typography align="center" className={classes.regText}>
        New tools like AWS Eventbridge aim to simplify the process of tracking events by providing an approach to activity monitoring that takes the burden away from the APIs that SaaS applications connect to. Amazon’s EventBridge is a serverless event bus that simplifies connecting applications together using data from your own applications, Software-as-a-Service (SaaS) applications, and AWS services. EventBridge provides a stream of real-time data from event sources, such as Kloudless, and then delivers that data to targets within AWS, such as AWS Lambda. This helps a wide range of applications, but none more so than apps requiring data sync and data collaboration. CASB, DLP, and eDiscovery applications can then be easily built to adhere to an Event-Driven Architecture that listens for webhooks across a series of CRUD endpoints.
      </Typography>
      <Typography align="center" className={classes.regText}>
      ...
      <Typography align="center" className={classes.regText}>
        Download a PDF version of this guide with even more information on everything your application needs to differentiate it from the competition.
      </Typography>
        <Button variant="contained" color="primary" className={classes.spacing} href="https://www.kloudless.com">
          Download Now
      </Button>
      </Container>
      <CardMedia
